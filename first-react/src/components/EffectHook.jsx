...
export default function EffectHook() {
    ...
    // useEffect를 사용해서 DidMount 일 떄 사용
    // useEffect (()=>{},[])
    // 두번쨰 인자값 [] 빈 배열일 떄, 컴포넌트 생성시에 실행
    useEffect(()=>{
        setInterval(()=>{
            setDate(new Date)
            console.log("실행")
    ...
    // useEffect의 두번쨰 인자값에 state의 값이 들어갈 때
    ...
    // useEffect 이용하여 생성할 때 
    // alert 사용하여 "컴포넌트 생성" 경고창 띄우기
    useEffect(()=>{
        alert("컴포넌트 생성")
    },[])
    // useEffect 이용하여 count 값 바뀔 때
